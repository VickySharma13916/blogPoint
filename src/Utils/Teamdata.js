...
export const TeamMemberData = [
  {
    ...
    designation: "Lead Medical Writer, BlogPoint Healthcare Solutions",
    about:
      "Somdatta Mukherjee is an accomplished medical writer with experience of more than six years in this field. Currently, she is working as a lead medical writer at BlogPoint Healthcare Solutions. She earned her MS degree in Cell and Molecular Biology from Fordham University, New York, USA, and worked as a Research Teaching Specialist at Rutgers University, New Jersey, USA. Writing about health and medicine is her passion and she enjoys using her skills to support the publication writing department at BlogPoint. Besides her professional interests, her other passion is travelling to exotic places and spending quality time with her family.",
  },
  {
    image: team2,
    title: "Mansi Mishra",
    ...
    about:
      "Mansi Mishra is a dedicated full-time medical writer at BlogPoint from 2020 and comes with more than nine years of experience in content management, digital content development, healthcare writing and editing across several therapeutic areas. She pursued her graduation in Biotechnology from Amity University, Noida, and her creative flair and inclination towards writing got her into the medical communications field. Mansi has an empathetic and positive attitude toward work and life. Besides being an avid fiction reader, she loves to travel and explore new places. She likes to try her hands on new recipes, dance, paint, or simply binge-watch shows or movies in her leisure time.",
  },
  {
    image: team3,
    title: "Dr. Aparna H Gopalkrishna",
    designation:
      "MDS, Oral and Maxillofacial Pathology Medical Reviewer and Team Lead, BlogPoint Healthcare Solutions",
    about:
  ...
  },
  {
    ...
    designation: "Lead QC Specialist, BlogPoint Healthcare Solutions",
    about:
  ...
  },
  {
    ...
    designation: "Senior Medical Writer, BlogPoint Healthcare Solutions",
    about:
  ...
  },
  {
    image: team7,
    title: "Ankita Mistry",
    designation: "Medical Writer, BlogPoint Healthcare Solutions",
    about:
      "Ankita is a firm believer that being proactive and taking responsibility is something which will take you higher in life. She is a passionate and dedicated full-time medical writer at BlogPoint Healthcare Solutions with a total experience of seven years in writing. Ankita is a pharmacist by qualification with a master’s degree in Pharmaceutics from the University of Mumbai. Other than work, she loves dancing, painting, and exploring skincare options and makeup.",
  },
  {
    image: team8,
  ...
  },
  {
    ...
    title: "Ashima Jawa",
    designation:
      "Sr. Executive Assistant & Human Resource, BlogPoint Healthcare Solutions",
    about:
      "With over six years of experience in an Executive Assistant & Human Resource position, Ashima has a track record of strong performance in high-pressure environments. She is particularly experienced in areas of strategic advice to operational managers; directing the administrative functions of complex organizations; developing company culture; mediating disputes and ensuring smooth operations. She has a robust knowledge of office management, efficient handling of inquiries, consultations, and timely access of resources to employees, compliance team, clients etc. Ashima joined BlogPoint in 2019, and presently, she is working closely with BlogPoint Group Directors to provide technical and logistical support and well-rounded experience - all the while being a friendly team player. Ashima also has extensive and diverse experience in team leading. Before BlogPoint, she served as Assistant Manager at ILSI-India and has also worked with many government officials and organizations in the past. Besides work, Ashima enjoys travelling and spending time with her family and friends.",
  },
  {
    image: team10,
    title: "Atul Teotia",
    designation:
      "Sr. Digital Transformation Specialist, BlogPoint Healthcare Solutions",
    about:
      "Atul Kumar is a Sr. Digital Transformation Specialist with over seven years of experience in Software development roles. His journey as a junior PHP developer started five years back and at BlogPoint, he has had a key role in creating our employee/resource management system. Atul had done his Master’s in Computer Applications from AKTU and got his bachelor’s degree in the same subject from CCSU. Besides work, Atul really enjoys bike riding, playing badminton, listening to music, and watching movies. He also loves to explore the Himalayas.",
  },
  {
    image: team11,
    title: "Sunil Kumar",
    designation:
      "Account Manager - Project Management, BlogPoint Healthcare Solutions",
    about:
  ...
  },
  {
    image: team18,
    title: "Diya Revankar",
    designation: "Graphic Designer, BlogPoint Healthcare Solutions",
    about:
      "Diya is a seasoned graphic designer and follows her passion towards the art in a professional capacity. She has over 11 years of designing experience with medical communication companies and she says associating with BlogPoint has been a wholesome experience for her when it comes to exploring new opportunities. Besides her professional interests, Diya is passionate about cooking and loves to spend quality time with her son.",
  },
];
...
export const TuracozTeam = [
  ...
  },
  {
    ...
    about:
      "BlogPoint is a place which gave me the opportunity to merge my profession and interest. An organization where learning never ends, is BlogPoint. From managers to team members, everyone is eager to guide and aid each other in their growth. The most amazing quality of BlogPoint is diversity, people from different parts of the world are working together with so much enthusiasm. I am learning wonderful things about medical writing, people, and myself every day. I am glad to be part of a team where ideas are respected, and vision is celebrated. Perfection, People and Planet, this organization is allowing me to grow in every dimension. Cheers to BlogPoint!",
  },
  {
    image: arushi,
    title: "Arushi Sharma",
    designation: "Project Management Associate",
    about:
      "I started my journey with BlogPoint in 2021 as a Project Management Trainee, and since then, I've grown a lot, both knowledge-wise and skill-wise. The company has given me many opportunities to widen my knowledge and for this, I will forever be grateful. I enjoy working here because of the positive work culture and super supportive colleagues. BlogPoint is a great place to work and could be a life-changing opportunity for people who would like to achieve a great career.",
  },
  {
    image: shribhagwan,
    ...
    about:
      "For me, it's been almost 4.5 years in BlogPoint. BlogPoint has provided me with a platform to learn, evolve, and constantly evaluate my progress. BlogPoint values 'hard work' & 'quality' that makes you more responsible at work. The founders and management team are open to discussing new ideas and improvements. I enjoy a very good work-life balance here. Every employee is always given a chance to share his/her problems, which helps to establish a healthy relationship. I am glad to be a part of this company and a wonderful young team!",
  },
];
